...
public class TranslatorEnpointTest {
	...
	public void testSendAndReceive() {
		...
		request.setText("Tomorrow I'll travel to St. Petersburg");
		...
		assertThat(((GetTranslationResponse) response).getTranslation(), is("Mañana me voy de viaje a San Petersburgo"));
	}	
}
